...
import { api_ShowProductDetail } from '@/utils/authService';
...
const ProductDetail = () => {
  ...
  const product = {
    ...
    price: 35000,
    originalPrice: 45000,
    description: "Cà chua organic được trồng tại Đà Lạt, đảm bảo không sử dụng thuốc trừ sâu, phân bón hóa học. Màu đỏ tươi, vị ngọt đậm đà, giàu vitamin C và các chất chống oxy hóa.",
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <button className="flex-1 px-6 py-3 text-white bg-green-600 rounded-lg hover:bg-green-700">
                Thêm vào giỏ hàng
              </button>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 py-2 border-b">
                <span className="text-gray-600">Chứng nhận</span>
                 <span className="col-span-2">{products.certification}</span> {/* Chua lam */}
              </div>
              <div className="grid grid-cols-3 py-2 border-b">
